    ...
    <section className="flex flex-col w-full items-center justify-center py-12 px-3 min-h-[80vh]">
      ...
      >
        ...
        <div className="flex items-center justify-between sm:col-span-2 my-2">
          <button
            type="button"
            className="py-2 px-2 text-md bg-indigo-600/10 text-indigo-500 rounded-md hover:bg-indigo-500/5 transition-colors focus:outline-none focus:ring-1 focus:ring-indigo-400 focus:ring-offset-2 cursor-pointer"
          >
            Add another job
          </button>
          <Link
