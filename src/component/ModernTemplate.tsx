...
export default function ResumeTemplate1({ data }: { data: ResumeData }) {
  return (
    <div className="min-h-[80vh] scale-container mx-auto">
      <article className="p-8 bg-white scale-temp shadow-md overflow-hidden border mx-auto  font-sans ">
        <section className="pb-4 mb-4 text-gray-950 ">
          ...
          <p className="flex gap-4 items-center">
            ...
            <Link
              className="text-blue-700"
              href={data.website ? data.website.trim() : ""}
            >
              {data.website?.trim()}
            </Link>
          </p>
